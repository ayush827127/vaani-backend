...
const shopItemsRoutes = require('./modules/shop-items/shop-items.routes');
...
app.use(cors({ origin: '*' }));
// Full data-sync batches (invoices + line items, items, customers) can exceed
...
app.use('/api/admin/shops/:shopId/items', shopItemsRoutes);
